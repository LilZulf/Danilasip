        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kelas VIII</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Kelas VIII</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url('manager/DataSiswa/detail/'.$datasiswa["NIS"]."/".$datasiswa['NAMA_KELAS']."/".$datasiswa['KODE_KELAS']."/3"); ?>"><?php echo $datasiswa['NAMA_SISWA'];?></a></td>
